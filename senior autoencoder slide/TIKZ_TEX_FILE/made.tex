...
\begin{tikzpicture}[
    ...
    neuron/.style={circle, draw, minimum size=4ex, thick, fill = orange!50},
  ...
  \begin{scope}[shift={(3cm,5cm)}, scale=0.4]
    \draw (0,0) grid (4,3);
    \node at (-1.8,1.5) {$M_V =$};
    \fill[teal!80] (0,1) rectangle ++(4,1);
    \fill[teal!80] (1,0) rectangle ++(2,1);

    \begin{scope}[yshift=-5cm]
      \draw (0,0) grid (4,4);
      \node at (-1.8,2) {$M_{W_2} =$};
      \fill[teal!80] (0,0) rectangle ++(1,1);
      \fill[teal!80] (0,3) rectangle ++(1,1);
      \fill[teal!80] (2,0) rectangle ++(2,1);
      \fill[teal!80] (2,3) rectangle ++(2,1);
    \end{scope}

    \begin{scope}[yshift=-10cm]
      \draw (0,0) grid (3,4);
      \node at (-1.8,2) {$M_{W_1} =$};
      \fill[teal!80] (0,0) rectangle ++(1,4);
      \fill[teal!80] (2,2) rectangle ++(1,1);
    \end{scope}
